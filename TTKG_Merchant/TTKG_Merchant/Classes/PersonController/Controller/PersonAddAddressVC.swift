...
class PersonAddAddressVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        NSNotificationCenter.defaultCenter().addObserver(self, selector: #selector(PersonAddAddressVC.selectAddressProcess(_:)), name: "selectAddress", object: nil)
    ...
    func saveBtnClick()  {
        ...
        if onlineState{
            ...
            requestAddAddress(userInfo_Global.keyid, name: name, phone: phone, address: address, country: country, code: code, sparetel: sparetel)
        }else{
...
extension PersonAddAddressVC: UITableViewDelegate, UITableViewDataSource{
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        cell.textView.addTarget(self, action: #selector(PersonAddAddressVC.didChangeText(_:)), forControlEvents: .EditingChanged)
        ...
        if indexPath.row == 2 {
            ...
            cell.textView.tag = indexPath.row
            cell.textView.text = noticeAddress
...
extension PersonAddAddressVC{
    
    func requestAddAddress(keyid:Int,name: String, phone:String, address:String, country: String, code: String, sparetel: String) {
        ...
        let parameters = ["userid":keyid,"usertype":1, "name":name , "phone":phone, "address":address, "country":country, "code":code, "sparetel":sparetel,"sign":MD5_time,"timespan":timeTemp.description]
        
        let url = serverUrl + "/address/add"
