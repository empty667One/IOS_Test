...
protocol HomeVCFirstHeaderViewDelegate {
    func FirstHeaderAddImageClickToPushVC()
}

class HomeVCFirstHeaderView: UICollectionReusableView {
    
    var delegate : HomeVCFirstHeaderViewDelegate?
    ...
    func addImageClick(){
        ...
        self.delegate?.FirstHeaderAddImageClickToPushVC()
    }
