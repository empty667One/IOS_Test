...
class BankVC: UIViewController {
    ...
    override func viewWillAppear(animated: Bool) {
        ...
        self.navigationItem.title = "金融服务"
    ...
    override func viewDidLoad() {
        ...
        createUI()
        titleArray = ["建设银行微企贷", "工商银行信用卡","民生银行信用卡"]
        imageArray = ["sehuo","ic_user_img","menu_address"]
...
extension BankVC : UITableViewDataSource, UITableViewDelegate{
